...
const onclick = () => (type = type === "password" ? "text" : "password");
export default {
	// view: ({ attrs }) => m(`input[type=${type}]`, { ...attrs, onclick }),
	view: ({ attrs }) => (
		<div class="relative">
			<input
			...
			<svg
				focusable="false"
				onclick={onclick}
				class={`${type === "password" ? "" : "hidden"} absolute right-2 top-3 cursor-pointer `}
				data-icon="eye"
				width="1em"
				height="1em"
				fill="currentColor"
